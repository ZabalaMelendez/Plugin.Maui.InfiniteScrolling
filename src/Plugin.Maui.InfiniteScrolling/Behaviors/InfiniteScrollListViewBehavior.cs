...
using Plugin.Maui.InfiniteScrolling;

namespace Plugin.Maui.InfiniteScrolling.Behaviors;

public class InfiniteScrollListViewBehavior : Behavior<ListView>
{
    ...
    public static readonly BindableProperty IsLoadingMoreProperty =
			BindableProperty.Create(
				...
				typeof(bool),
				typeof(InfiniteScrollListViewBehavior),
				default,
		...
		{
			if (bindable is InfiniteScrollListViewBehavior behavior)
			{
